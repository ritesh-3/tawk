...
export default function SettingColorPresets({handleChange, selectedColor}) {
  const { themeColorPresets, colorOption } = useContext(GlobalContext);

  return (
    <RadioGroup name="themeColorPresets" value={selectedColor} onChange={handleChange}>
